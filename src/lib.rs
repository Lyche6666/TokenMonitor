...
#[derive(Debug)]
pub struct TokenMonitorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenMonitorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenMonitor processing");
    
    let mut processor = TokenMonitorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenMonitorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenMonitorProcessor::new(false);
